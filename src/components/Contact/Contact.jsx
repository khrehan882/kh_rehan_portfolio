    ...
    return(
        <Container style={{paddingTop: '50px'}} >
            ...
            <Col md={6} className="c-right">
                ...
                <span className='done'>{done && "Thanks for contacting me. There may be a problem with reaching out this message, If you have any serious query you can conatct me on Linkedin."}</span>
                </form>
            </Col>
            </Row>
        </Container>
