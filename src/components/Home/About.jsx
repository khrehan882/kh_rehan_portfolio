          ...
          <Container>
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <br />
                <br />
                I recently graduated with a Bachelor's degree in Software Engineering in 2024.
                <br />
                <br />
                  As a
                  ...
                  <br />I am proficient in
                    ...
                    as well as have knowledge in programming languages such as C++, JavaScript, Python,
                  <br />
                  <br />
